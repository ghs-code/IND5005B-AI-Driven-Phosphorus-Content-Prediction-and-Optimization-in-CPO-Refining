...
.PHONY: help init-config mkdirs install preprocess preprocess-multi ols acf rf-full rf-core rf-combo feed-opt feed-opt-yearly final-feed models models-multi final-eda cross-year all
